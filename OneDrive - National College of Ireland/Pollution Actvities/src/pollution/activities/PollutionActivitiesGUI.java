 ...
 * @author tombr
 */
public class PollutionActivitiesGUI extends javax.swing.JFrame {
    PollutionActivities plist[];
    private int count;
    /**
     * Creates new form pollutionActivitiesGUI
     */
    public PollutionActivitiesGUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PollutionActivitiesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
